class HeartsFlow {
	...
	change() {
		...
		document.querySelector(".bglove").style.visibility = "visible";
...
function Rise() {
	// console.log("动画结束");
	document.getElementById("liker").style.visibility = "visible";
}
...
window.onload = function() {
	...
	setTimeout("window.location= 'step3.html'",14000);
}